        ...
        $.proxy(function (l, n) {
          ...
          for (c = 0; c < d; c++) {
            ...
            var w = m.easing,
              x = m["easing-return"];
            if (
              ((null != w && $.easing && $.easing[w]) || (w = null),
              (null != x && $.easing && $.easing[x]) || (x = w),
              w)
            ) {
              var g = m.duration;
                ...
                $.proxy(function (a) {
                  ...
                  if (null != e) {
                    ...
                    if (w && _ > 0 && _ <= g) {
                      ...
                      "back" == s.data("sens") &&
                        ((c = e), (e = -e), (w = x), (g = f)),
                        (o = $.easing[w](null, _, c, e, g));
                    }
                    (o = Math.ceil(o * this.round) / this.round) == l &&
                      n == e &&
                      (o = e),
                      r[a] || (r[a] = 0),
                      (r[a] += o),
                      l != r[a] && (s.data("_" + a, r[a]), (i = !0));
                  }
                }, this)
              );
          }
          if (i) {
            ...
            null == r.scaleX && (r.scaleX = 1),
              null == r.scaleY && (r.scaleY = 1),
              null == r.scaleZ && (r.scaleZ = 1),
              null != r.scale &&
                ((r.scaleX *= r.scale),
                (r.scaleY *= r.scale),
                (r.scaleZ *= r.scale));
            ...
            this._log(Z),
              s.attr(
                "style",
                "transform:" + Z + " -webkit-transform:" + Z + " " + o
              );
          }
        }, this)
      ),
