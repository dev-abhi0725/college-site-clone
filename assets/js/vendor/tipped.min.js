...
!(function (t, i) {
  ...
  var getUID =
      ((U = 0),
      function (t) {
        for (t = t || "_tipped-uid-", U++; document.getElementById(t + U); )
          U++;
        return t + U;
      }),
    U,
    Position = {
      ...
      getDistance: function (t, i, e, s) {
        return Math.sqrt(
          Math.pow(Math.abs(e - t), 2) + Math.pow(Math.abs(s - i), 2)
        );
      },
        ...
        return a
          ? ((u =
            ...
            0 <= (f = (-p * (t - o) + d * (i - n)) / (-l * p + d * c)) &&
              ...
              0 <= u &&
              u <= 1 && { x: t + u * d, y: i + u * p })
          : Sa(t, i, o, n, r, h) != Sa(e, s, o, n, r, h) &&
              Sa(t, i, e, s, o, n) != Sa(t, i, e, s, r, h);
        var d, p, l, c, f, u;
      },
    },
    X;
  ...
  var Bounds = {
    ...
    Mouse = {
      ...
      getPosition: function (t) {
        ...
        return {
          left:
            i.left - Math.round(0.5 * this._dimensions.width) + this._shift.x,
          top:
            i.top - Math.round(0.5 * this._dimensions.height) + this._shift.y,
        };
      },
      ...
      build: function () {
        ...
        for (var e = this.options.lines, s = 0; s < e; s++) {
          ...
          this._rotate.append(
            ...
            o.css({ opacity: ((1 / e) * (s + 1)).toFixed(2) });
          var r = {};
      ...
      initialize: function (t) {
        return (
          ...
          $.each(
            ...
            $.proxy(function (t, i) {
              var e = $(i).is(":visible");
              e || $(i).show(), this._restore.push({ element: i, visible: e });
            }, this)
          ),
          this
        );
  ...
  var AjaxCache =
      ((Qb = []),
      {
        ...
        set: function (t, i, e) {
          var s = this.get(t);
          s || ((s = $.extend({ callbacks: {} }, t)), Qb.push(s)),
            (s.callbacks[i] = e);
        },
        remove: function (t) {
          for (var i = 0; i < Qb.length; i++)
            Qb[i] && Qb[i].url === t && delete Qb[i];
        },
        clear: function () {
          Qb = [];
        },
    ...
    Voila = (function (r) {
      function h(t, i, e) {
        ...
        return (
          (this.options = r.extend({ method: "onload" }, o)),
      ...
      r.extend(h.prototype, {
        _add: function (t) {
          var i =
            "string" == r.type(t)
              ? r(t)
              : t instanceof jQuery || 0 < t.length
              ? t
              : [t];
          r.each(
            i,
                ...
                if (this._test()) this.success();
                  ...
                  if (
                    ...
                    if (!this.options.intervals[this._ipos + 1])
                      return void (
                        "function" == n.type(this._timeout) && this._timeout()
                      );
                    this._ipos++,
                      (this._delay = this.options.intervals[this._ipos][1]);
                  }
  ...
  var Options = { create: Rc },
    Oc,
    Pc;
  function Rc(t) {
    return (
      (Oc = Tipped.Skins.base),
      (Pc = deepExtend($.extend({}, Oc), Tipped.Skins.reset)),
      (Rc = Uc)(t)
    );
  }
  function Sc(t) {
  ...
  function Tc(t) {
    var i;
    return t.behavior && (i = Tipped.Behaviors[t.behavior])
      ? deepExtend($.extend({}, i), t)
      : t;
  }
  function Uc(t) {
    ...
    if (n.ajax) {
      Pc.ajax;
      var r = Oc.ajax;
      "boolean" === $.type(n.ajax) && (n.ajax = {}),
        (n.ajax = deepExtend($.extend({}, r), n.ajax));
    }
    var h = (h =
    ...
    if (
      ...
      "mouse" === n.target
        ? ((a = $.extend({}, Oc.offset)),
          ...
          (a = Position.adjustOffsetBasedOnPosition(
            Oc.offset,
            Oc.position,
            s.target,
            !0
        ...
        : (a = { x: n.offset.x, y: n.offset.y }),
      (n.offset = a),
      n.hideOn &&
        "click-outside" === n.hideOn &&
        ((n.hideOnClickOutside = !0), (n.hideOn = !1), (n.fadeOut = 0)),
      n.showOn)
    ) {
      var l = n.showOn;
      "string" === $.type(l) && (l = { element: l }), (n.showOn = l);
    }
    if (n.hideOn) {
      var c = n.hideOn;
      "string" === $.type(c) && (c = { element: c }), (n.hideOn = c);
    }
    return (
      n.inline && "string" !== $.type(n.inline) && (n.inline = !1),
      Browser.IE &&
        Browser.IE < 9 &&
        $.extend(n, { fadeIn: 0, fadeOut: 0, hideDelay: 0 }),
      n.spinner &&
        (Spin.supported
          ? "boolean" === $.type(n.spinner) &&
            (n.spinner = Pc.spinner || Oc.spinner || {})
          : (n.spinner = !1)),
      ...
      n.containment &&
        ...
        (n.containment = {
          ...
          padding:
            (Pc.containment && Pc.containment.padding) ||
            (Oc.padding && Oc.containment.padding),
        }),
  ...
  $.extend(Skin.prototype, {
    initialize: function (t) {
      ...
      this.tooltip._tooltip[(n.shadow ? "remove" : "add") + "Class"](
        "tpd-no-shadow"
      )
      ...
      this.element
                  ...
                  $("<div>")
                    ...
                    .append(
                      (e = $("<div>")
                        ...
                        .append(
                          (s = $("<div>").addClass("tpd-background-content"))
                        ))
                    )
                )
            ))
        ...
        e.css({ width: 999, height: 999, zoom: 1 }),
        (this._css = {
          ...
          spinner: {
            dimensions: { width: o.innerWidth(), height: o.innerHeight() },
          },
        }),
        o.remove(),
        i.remove(),
    ...
    _getFrame: function (t) {
      ...
      i.addClass("tpd-frame-" + t),
        ...
        this.tooltip.options.stem &&
          i.find(".tpd-stem").attr("data-stem-position", t);
      var e = Math.max(this._css.radius - this._css.border, 0);
      i
        .find(".tpd-background-title")
        .css({ "border-top-left-radius": e, "border-top-right-radius": e }),
        i
        ...
        i.find(".tpd-background-loading").css({ "border-radius": e });
      var s = { backgroundColor: this._css.borderColor };
      s["horizontal" === Position.getOrientation(t) ? "height" : "width"] =
        this._css.border + "px";
      return (
        (s[
          { top: "bottom", bottom: "top", left: "right", right: "left" }[t]
        ] = 0),
      ...
      if (
        ...
        if (this.tooltip.options.stem)
          if (
            (o
              .find(".tpd-shift-stem")
              .css($.extend({}, s.shift.dimensions, s.shift.position)),
            "vertical" === r)
          ) {
            (a = o.find(
              ...
              o
                ...
                .css({ top: s.dimensions.height - this._vars.cut })
            ...
            var h =
              "right" === e
                ? s.dimensions.width - s.stemPx - this._css.border
                : 0;
            a
              .css({ left: h })
              .find(".tpd-background-box-shift")
              .css({ "margin-left": -1 * h }),
              o
                .find(".tpd-background-box-" + ("left" == e ? "left" : "right"))
                .hide(),
              "right" === e
                ? o
            ...
            (a = o.find(
              ...
              o
                .find(".tpd-background-box-right")
                .css({ left: s.dimensions.width - this._vars.cut })
                .find(".tpd-background-box-shift")
                .css({
            ...
            h =
              "bottom" === e
                ? s.dimensions.height - s.stemPx - this._css.border
                : 0;
            a
              .css({ top: h })
              .find(".tpd-background-box-shift")
              .css({ "margin-top": -1 * h }),
              o
                .find(".tpd-background-box-" + ("top" === e ? "top" : "bottom"))
                .hide(),
              "bottom" === e
                ? o
        ...
        this._spinner.css({
          top:
            l.top +
            this._css.border +
            (0.5 * c.height - 0.5 * this._css.spinner.dimensions.height),
          left:
            l.left +
            this._css.border +
            (0.5 * c.width - 0.5 * this._css.spinner.dimensions.width),
        });
      }
    },
    getVars: function () {
        ...
        $.each(
          ...
          $.proxy(function (t, i) {
            ...
            switch (
              ...
              case "top":
              case "bottom":
                (n.shift.position.left += a.cut),
                  "bottom" === i && (n.shift.position.top += s.height - r - p);
                break;
              case "left":
              case "right":
                (n.shift.position.top += a.cut),
                  "right" === i && (n.shift.position.left += s.width - r - p);
            }
          }, this)
        ),
        (a.connections = {}),
    ...
    setDimensions: function (t) {
      ...
      (i && i.width === t.width && i.height === t.height) ||
    ...
    getConnectionLayout: function (t, i) {
      var e = Position.getSide(t),
        ...
        n = this["stem_" + e],
        r = i.stemOffset,
        h = this.tooltip.options.stem
          ? n.getMath().dimensions.outside.width
          : 0,
        a = o + r + 0.5 * h,
        d = { stem: {} },
      ...
      if ("horizontal" == s) {
        ...
        this.tooltip.options.stem &&
          ((u = f.shift.dimensions.width) - h < 2 * r &&
            (r = Math.floor(0.5 * (u - h)) || 0),
          (a = o + r + 0.5 * h));
        var m = u - 2 * r,
          g = r;
        switch ((v = Position.split(t))[2]) {
          ...
          case "right":
            (g += m - h),
              (p.left = m - h),
              (l.left = f.dimensions.width - a),
              (c.left = f.dimensions.width);
        }
        "bottom" === v[1] &&
          ((l.top += f.dimensions.height), (c.top += f.dimensions.height)),
          $.extend(d.stem, {
            position: { left: g },
            before: { width: g },
            after: { left: g + h, width: u - g - h + 1 },
          });
      } else {
        var b = f.dimensions.height;
        this.tooltip.options.stem &&
          ((b = f.shift.dimensions.height) - h < 2 * r &&
            (r = Math.floor(0.5 * (b - h)) || 0),
          (a = o + r + 0.5 * h));
        var v,
          _ = b - 2 * r,
          x = r;
        switch ((v = Position.split(t))[2]) {
          ...
          case "bottom":
            (x += _ - h),
              (p.up = _ - h),
              (l.top = f.dimensions.height - a),
              (c.top = f.dimensions.height);
        }
        "right" === v[1] &&
          ((l.left += f.dimensions.width), (c.left += f.dimensions.width)),
          $.extend(d.stem, {
            position: { top: x },
            before: { height: x },
            after: { top: x + h, height: b - x - h + 1 },
          });
      }
    ...
    setStemShift: function (t, i) {
      ...
      if (
        ...
        this._shift = { stemPosition: t, shift: i, dimensions: s };
    ...
    $.extend(Stem.prototype, {
      ...
      build: function () {
        ...
        var t = this._css.backgroundColor,
          i =
            -1 < t.indexOf("rgba") && parseFloat(t.replace(/^.*,(.+)\)/, "$1")),
          e = i && i < 1;
      ...
      buildTransform: function () {
        ...
        if (
          ...
          var o = {};
          "top" === s
            ? ((o.bottom = 0), (o.top = "auto"))
            : "left" === s && ((o.right = 0), (o.left = "auto")),
        ...
        (r[n] = "translate(" + t.border * e + "px, 0)"),
          this.element.find(".tpd-stem-triangle").css(r);
        var h = this._css.borderColor;
        (alpha =
          -1 < h.indexOf("rgba") && parseFloat(h.replace(/^.*,(.+)\)/, "$1"))),
          alpha && alpha < 1
            ? (h = (h.substring(0, h.lastIndexOf(",")) + ")").replace(
                "rgba",
                "rgb"
              ))
            : (alpha = 1);
      ...
      buildNoTransform: function () {
                      ...
                      $("<div>")
                        ...
                        .append(
                          $("<div>")
                            ...
                            .append(
                              $("<div>").addClass("tpd-stem-border-center")
                            )
                        )
                    )
                )
        ...
        (h[e ? "height" : "width"] = "100%"),
          ...
          (h[s ? "top" : "bottom"] = 0),
          $.extend(h, o ? { left: 0 } : { right: 0 }),
          this.element.find(".tpd-stem-border-corner").css(h);
        var a = { width: 0, "background-color": "transparent", opacity: 1 },
        ...
        if (e) {
          ...
          $.extend(a, l),
            (a[o ? "right" : "left"] = 0),
            (a[o ? "border-left" : "border-right"] =
              i.inside.height + "px solid " + this._css.borderColor),
            $.extend(p, l),
            (p[o ? "border-left" : "border-right"] =
              i.inside.height + "px solid " + this._css.backgroundColor),
            (p[o ? "right" : "left"] = t.top),
            (p[o ? "left" : "right"] = "auto"),
            this.element
              .find(".tpd-stem-border-center-offset")
              .css({ "margin-left": -1 * this._css.border * (o ? -1 : 1) })
              .find(".tpd-stem-border-center-offset-inverse")
              .css({ "margin-left": this._css.border * (o ? -1 : 1) });
        } else {
          var l = {
          ...
          $.extend(a, l),
            (a[s ? "border-top" : "border-bottom"] =
              i.inside.height + "px solid " + this._css.borderColor),
            $.extend(p, l),
            (p[s ? "border-top" : "border-bottom"] =
              i.inside.height + "px solid " + this._css.backgroundColor),
            (p[s ? "bottom" : "top"] = t.top),
            (p[s ? "top" : "bottom"] = "auto"),
            this.element
              .find(".tpd-stem-border-center-offset")
              .css({ "margin-top": -1 * this._css.border * (s ? -1 : 1) })
              .find(".tpd-stem-border-center-offset-inverse")
              .css({ "margin-top": this._css.border * (s ? -1 : 1) });
        }
  ...
  var Tooltips = {
    ...
    onWindowResize: function () {
      this._resizeTimer &&
        (window.clearTimeout(this._resizeTimer), (this._resizeTimer = null)),
    ...
    _getTooltips: function (t, i) {
      ...
      if (
        ...
        var n = this.getTooltipByTooltipElement(
          $(t).closest(".tpd-tooltip")[0]
        );
        n &&
          n.element &&
          (e = $(n.element).data("tipped-uids") || []) &&
          (s = s.concat(e));
      }
      return (
        0 < s.length &&
    ...
    get: function (e) {
      var t = $.extend({ api: !1 }, arguments[1] || {}),
        s = [];
      return (
        _.isElement(e)
      ...
      $.each(
        ...
        $.proxy(function (t, i) {
          i.options.ajax &&
            (i._cache &&
              i._cache.xhr &&
              (i._cache.xhr.abort(), (i._cache.xhr = null)),
            i.is("updated", !1),
            i.is("updating", !1),
            i.is("sanitized", !1));
        }, this)
    ...
    removeDetached: function () {
      ...
      0 < t.length &&
        ...
        $.each(
          ...
          $.proxy(function (t, i) {
            i.element &&
              !_.element.isAttached(i.element) &&
              this.remove(i.element);
          }, this)
        ),
        $.each(e, function (t, i) {
          i.detach();
  ...
  (Tooltips.Position = {
    ...
    getInversedPosition: function (t) {
      var i = Position.split(t),
        ...
        n = $.extend({ horizontal: !0, vertical: !0 }, arguments[1] || {});
      return (
        "horizontal" === o
          ? (n.vertical && (e = this.inversedPosition[e]),
            n.horizontal && (s = this.inversedPosition[s]))
          : (n.vertical && (s = this.inversedPosition[s]),
            n.horizontal && (e = this.inversedPosition[e])),
        e + s
      );
    },
    ...
    $.extend(Tooltip.prototype, {
        ...
        if (((this.element = element), this.element)) {
          ...
          if (
            ...
            title &&
              ...
              "undefined" != $.type(this.options.title) &&
      ...
      remove: function () {
        ...
        if (
          (-1 < i && (t.splice(i, 1), $(this.element).data("tipped-uids", t)),
          t.length < 1)
        ) {
          var e,
        ...
        if (this.is("detached")) {
          ...
          if ("string" === $.type(this.options.container)) {
            ...
            "mouse" === i && (i = this.element),
              (t = $($(i).closest(this.options.container).first()));
            ...
            this.bind(
              ...
              $.proxy(function (t) {
                if (this.visible()) {
                  ...
                  (!i || (i && i !== this._tooltip[0] && i !== this.element)) &&
                    this.hide();
                }
              }, this)
            )),
    ...
    $.extend(Tooltip.prototype, {
      ...
      update: function (n) {
        if (!this.is("updating")) {
          ...
          var t = this.options.inline
            ...
            ? "function"
            : "html";
          switch ((this._contentWrapper.css({ visibility: "hidden" }), t)) {
            case "html":
            case "element":
            case "inline":
            ...
            case "ajax":
              var e = this.options.ajax || {},
                ...
                o = e.dataType,
                r = { url: s, data: e.data || {} };
              (t = e.type || "GET") && $.extend(r, { type: t }),
                o && $.extend(r, { dataType: o });
              var h,
                a = $.extend({}, r, e);
              if (
                      ...
                      (a[o] = _.wrap(
                        ...
                        $.proxy(function (t) {
                          ...
                          if (!e.statusText || "abort" !== e.statusText) {
                            this.options.cache &&
                              AjaxCache.set(
                                { url: a.url, type: a.type, data: a.data },
                                o,
                                i
                              ),
                              (this._cache.xhr = null);
      ...
      _update: function (t, i) {
        var e = { title: this.options.title, close: this.options.close };
        "string" === $.type(t) ||
        _.isElement(t) ||
        _.isText(t) ||
        ...
        (this.content = t),
          ...
          this._close[
            (this.title || this.options.title) && o ? "show" : "hide"
          ]();
        ...
        this._inner_close[n ? "show" : "hide"](),
          this._tooltip[(r ? "add" : "remove") + "Class"](
            "tpd-has-inner-close"
          ),
          this._tooltip[(h ? "add" : "remove") + "Class"](
            "tpd-has-title-close"
          ),
      ...
      finishUpdate: function (t) {
        if (
          ...
          i && this._contentWrapper.css({ visibility: "visible" }),
            this.options.afterUpdate(this._content[0], this.element),
            i && this._contentWrapper.css({ visibility: "hidden" });
        }
        t && t();
      },
    }),
    $.extend(Tooltip.prototype, {
      ...
      updateDimensionsToContent: function (t, i) {
        ...
        if (
          ...
          var a = { top: r, right: r, bottom: r, left: r },
            d = 0;
          if ("vertical" === Position.getOrientation(i)) {
            this.options.stem &&
              (a[o] =
                this.skin["stem_" + o].getMath().dimensions.outside.height);
            ...
            var l = this.getContainmentLayout(i),
              ...
              f = !1;
            if (
              Position.isPointWithinBoxLayout(c.x1, c.y1, l) ||
              Position.isPointWithinBoxLayout(c.x2, c.y2, l)
            )
              f = !0;
            else {
              $.each(
            ...
            f &&
              ((d =
                "left" === o
                  ? c.x1 - l.position.left
                  : l.position.left + l.dimensions.width - c.x1),
              (a[o] += d));
          }
          if (this.options.offset && "vertical" === n) {
            var u = Position.adjustOffsetBasedOnPosition(
              this.options.offset,
          ...
          this.options.containment &&
            ...
            "vertical" === n
              ? (a["left" === o ? "left" : "right"] -= d)
              : (a["top" === o ? "top" : "bottom"] -= d));
          ...
          this.close &&
            ...
            this._contentRelativePadder.css({ "padding-right": g.width }),
            this._contentSpacer.css({ width: m.width - a.left - a.right });
          var b = {
          ...
          if (this.title) {
            ...
            this._titleWrapper
              ...
              this._maxWidthPass &&
                ...
                this._titleRelative.css({ width: b.width }),
            ...
            (v = {
              ...
              height: Math.max(
                this.title ? this._titleWrapper.innerHeight() + x : 0,
                _.height + x
              ),
            }).width >
          ...
          if (this.options.stem) {
            var w = "vertical" === n ? "height" : "width",
              y =
                this.skin["stem_" + o].getMath().outside.width +
                2 * this.skin._css.radius;
            b[w] < y && (b[w] = y);
          }
          if (
            (this._contentSpacer.css({ width: b.width }),
            b.height !==
              Math.max(this._content.innerHeight(), g.height) +
                (this.title ? this._titleRelative.outerHeight() : 0) &&
              b.width++,
            this.is("resize-to-content") ||
              (b = this.skin._css.spinner.dimensions),
            this.setDimensions(b),
            (a = { top: r, right: r, bottom: r, left: r }),
            this.options.stem)
          ) {
          ...
          this.options.maxWidth &&
            ...
            !this._maxWidthPass &&
            this.is("resize-to-content") &&
            (k.css({ width: this.options.maxWidth }),
      ...
      getContainmentSpace: function (t, i) {
        ...
        return (
          ...
          o.left > r.left + h.width &&
            r.left + h.width >= o.left &&
            (a.left -= o.left - (r.left + h.width)),
        ...
        if (this.visible()) {
          ...
          if (this.options.containment) {
            ...
            if (
              ...
              (r.unshift({ position: n, targetPosition: o, stemPosition: s }),
              (o = Position.flip(i)),
              (s = Position.flip(e)),
              a[Position.getSide(o)]
                ? (this.updateDimensionsToContent(o, s),
                  (n = this.getPositionBasedOnTarget(o, s)))
                : (n.contained = !1),
              n.contained)
            )
                ...
                if (
                  ($.each(r, function (t, i) {
                    if (0 <= i.position.top && 0 <= i.position.left) u = i;
                      ...
                      var e =
                          0 <= i.position.top ? 1 : Math.abs(i.position.top),
                        s =
                          0 <= i.position.left ? 1 : Math.abs(i.position.left);
                      m.push({ result: i, negativity: e * s });
                    }
                  }),
                  !u)
                ) {
      ...
      getPositionBasedOnTarget: function (t, i) {
        ...
        if (this.options.offset) {
          ...
          (y = Position.adjustOffsetBasedOnPosition(
            y,
            this.options.position.target,
            t
          )),
        ...
        var T = this.getContainment({ top: c.top, left: c.left }, i),
        ...
        if (!T[C]) {
          ...
          if (0 !== D) {
            ...
            if (D * L <= E && c[z] + D >= A)
              ...
              Position.getOrientation(t) === Position.getOrientation(i)
            ) {
              if (((c[z] += E * L), (P[M] = E * L * -1), c[z] < A)) {
                ...
                var H = P[M] - j;
                H >= r.connections[i].move[O[0]] &&
                  H <= r.connections[i].move[O[1]] &&
                  (P[M] -= j);
              }
              var R = (T = this.getContainment({ top: c.top, left: c.left }, i))
                  .correction[M],
                F = deepExtend({}, c);
              this.options.offset &&
              ...
              (c = F),
                this.options.offset &&
                  ((c.left += this.options.offset.x),
                  (c.top += this.options.offset.y));
            }
          }
          k =
            (T = this.getContainment({ top: c.top, left: c.left }, i))
              .horizontal && T.vertical;
        }
        return { top: c.top, left: c.left, contained: k, shift: P };
      },
      setPosition: function (t, i) {
        ...
        if (!e || e.top !== t.top || e.left !== t.left) {
          ...
          if (this.options.container !== document.body) {
            if ("string" === $.type(this.options.container)) {
              var o = this.target;
              "mouse" === o && (o = this.element),
                (s = $($(o).closest(this.options.container).first()));
            } else s = $(s);
            if (s[0]) {
              var n = $(s).offset(),
                r = Math.round(n.top),
      ...
      getSideLine: function (t, i) {
        ...
        switch (i) {
          ...
          case "left":
            ...
            break;
          case "right":
            (e += t.dimensions.width),
              (o += t.dimensions.width),
              (n += t.dimensions.height);
        }
        return { x1: e, y1: s, x2: o, y2: n };
      },
      isSideWithinContainment: function (t, i, e) {
        ...
        if (
          Position.isPointWithinBoxLayout(n.x1, n.y1, s) ||
          Position.isPointWithinBoxLayout(n.x2, n.y2, s)
        )
          return !0;
        var r = !1;
        return (
      ...
      getContainment: function (t, i) {
        var e = { horizontal: !0, vertical: !0, correction: { y: 0, x: 0 } };
        if (this.options.containment) {
          var s = this.getContainmentLayout(i),
            o = this.skin._vars.frames[Position.getSide(i)].dimensions;
          this.options.containment &&
            ((t.left < s.position.left ||
              t.left + o.width > s.position.left + s.dimensions.width) &&
              ((e.horizontal = !1),
              t.left < s.position.left
                ? (e.correction.x = s.position.left - t.left)
                : (e.correction.x =
                    s.position.left + s.dimensions.width - (t.left + o.width))),
            (t.top < s.position.top ||
              t.top + o.height > s.position.top + s.dimensions.height) &&
              ((e.vertical = !1),
              t.top < s.position.top
      ...
      getContainmentLayout: function (t, i) {
        var e = { top: $(window).scrollTop(), left: $(window).scrollLeft() },
          s = this.target;
        ...
        o =
          n && "viewport" !== this.options.containment.selector
            ...
            : { dimensions: Bounds.viewport(), position: e };
          ...
          if ((h < 2 * r && (r = Math.max(Math.floor(0.5 * h), 0)), r))
            (o.dimensions.width -= 2 * r),
              ...
              "vertical" === Position.getOrientation(t)
                ? ((o.dimensions.width += r),
                  "left" === Position.getSide(t) && (o.position.left -= r))
                : ((o.dimensions.height += r),
                  "top" === Position.getSide(t) && (o.position.top -= r));
        }
            ...
            "mouse" === this.options.target
              ? this.is("api")
                ? ((i = $(this.element).offset()),
                  { top: Math.round(i.top), left: Math.round(i.left) })
      ...
      getPaddingLine: function (t) {
        ...
        if ("vertical" === Position.getOrientation(t))
          return this.getSideLine(i, Position.getSide(t));
        if (Position.isCorner(t)) {
    ...
    $.extend(Tooltip.prototype, {
      bind: function (t, i, e, s) {
        ...
        this._cache.events.push({ element: t, eventName: i, handler: o }),
          $(t).bind(i, o);
      },
      unbind: function () {
    ...
    $.extend(Tooltip.prototype, {
      is: function (t, i) {
        return (
          "boolean" === $.type(i) && (this._cache.is[t] = i), this._cache.is[t]
        );
      },
      visible: function () {
    ...
    $.extend(Tooltip.prototype, {
      ...
      clearTimer: function (t) {
        this._cache.timers[t] &&
          (clearTimeout(this._cache.timers[t]), delete this._cache.timers[t]);
      },
  ...
  var Delegations = {
    ...
    add: function (t, e, s) {
      ...
      (this._delegations[o].removeTitleHandler = $.proxy(
        this.removeTitle,
        this
      )),
        $(document).delegate(
    ...
    removeTitle: function (t) {
      var i = t.currentTarget,
        e = $(i).attr("title");
      e &&
        ($(i).data("tipped-restore-title", e),
        $(i)[0].setAttribute("title", ""));
    },
    remove: function (e) {
      $.each(
        this._delegations,
        $.proxy(function (t, i) {
          i.selector === e &&
            ($(document)
              .undelegate(
                e + ":not(.tpd-delegation-uid-" + t + ")",
                "mouseenter",
                i.removeTitleHandler
              )
              .undelegate(
                e + ":not(.tpd-delegation-uid-" + t + ")",
                i.options.showOn.element,
                i.handler
              ),
    ...
    removeAll: function () {
      $.each(
        ...
        $.proxy(function (t, i) {
          $(document)
            .undelegate(
              i.selector + ":not(.tpd-delegation-uid-" + t + ")",
              "mouseenter",
              i.removeTitleHandler
            )
            .undelegate(
  ...
  return (
    $.extend(Collection.prototype, {
      ...
      remove: function () {
        return (
          Tooltips.removeTooltips(this.tooltips), (this.tooltips = []), this
        );
      },
    }),
